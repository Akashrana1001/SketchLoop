...
export default function LightRays({
    ...
    useEffect(() => {
        ...
        // Delay setup very slightly so layout dimensions are stable before creating WebGL resources.
...
void main() {
    ...
    gl_FragColor = color;
            ...
            // Full cleanup prevents leaked RAF loops and stale WebGL contexts on route changes.
            cleanupRef.current = () => {
